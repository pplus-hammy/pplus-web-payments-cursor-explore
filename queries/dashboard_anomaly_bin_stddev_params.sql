-- Dashboard anomaly panel: parameterized for API. Params: @run_range_start, @run_range_end, @z_threshold, @src_system_ids (ARRAY<INT64>).
-- Same logic as dashboard_anomaly_bin_stddev.sql; output: run_dt, cc_first_6_nbr, rate_pct, baseline_avg, z_score, flagged.
