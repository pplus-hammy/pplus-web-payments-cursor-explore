-- DOW baseline: flag bins (cc_first_6_nbr) whose share of daily transactions (rate % of total) deviates from same-day-of-week baseline.
-- Uses percent of total transactions per bin per day; baseline = avg/stddev of that rate over 3-month same-dow lookback. Optional excluded_dts.
